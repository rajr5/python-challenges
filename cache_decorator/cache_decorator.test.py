...
# We provided *args as a param so we can more easily test for different inputs to the function.
...
class TestCacheDecorator(unittest.TestCase):
    ...
    def test_time_based_cache(self):
        cached_random_function = CacheDecorator(ttl_seconds=0.1, call_limit=999999)(get_random_number)
        results = []
    ...
    def test_custom_cache_count(self):
        ...
        cached_random_function = CacheDecorator(call_limit=cached_number_of_calls)(get_random_number)
        range_size = 50
